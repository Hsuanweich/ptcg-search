...
num_classes = 5  # 假設有 5 個類別
mobilenet_v2.classifier[1] = torch.nn.Linear(mobilenet_v2.last_channel, num_classes)
mobilenet_v2.load_state_dict(torch.load("/home/ptcg/PTCGHTML/ptcg_cards/classify/mobilenet_v2_finetuned_1.pth", map_location=torch.device('cpu')),strict=True )
mobilenet_v2.eval()
"""
***************************************************************************
